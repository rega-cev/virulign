...
if(HG_EXECUTABLE AND NOT DEFINED VAL_VERSION)
  ...
  if(NOT HG_LOG_ERROR_CODE AND NOT HG_ID_ERROR_CODE)
    set(VIRULIGN_VERSION ${HG_REVISION})
  endif()
endif()

# Generate a git-describe version string from Git repository tags
if(GIT_EXECUTABLE AND NOT DEFINED VIRULIGN_VERSION)
  execute_process(
  ...
  if(NOT GIT_DESCRIBE_ERROR_CODE)
    set(VIRULIGN_VERSION ${GIT_DESCRIBE_VERSION})
  endif()
endif()

# Final fallback: Just use a bogus version string that is semantically older
# than anything else and spit out a warning to the developer.
if(NOT DEFINED VIRULIGN_VERSION)
  set(VIRULIGN_VERSION v0.0.0-unknown)
  message(WARNING "Failed to determine VIRULIGN_VERSION from repository tags. Using default version \"${VIRULIGN_VERSION}\".")
endif()
