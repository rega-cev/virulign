...
static inline void move_up(int lines) { std::cerr << "\033[" << lines << "A"; }
static inline void move_down(int lines) { std::cerr << "\033[" << lines << "B"; }
static inline void move_right(int cols) { std::cerr << "\033[" << cols << "C"; }
static inline void move_left(int cols) { std::cerr << "\033[" << cols << "D"; }
